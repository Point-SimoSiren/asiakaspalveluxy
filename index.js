...
const PORT = process.env.PORT || 5000; // Mahdollistaa julkaisualustan tarjoaman portin käytön
const app = express();
...
io.on('connection', (socket) => {
  // Kun palvelin vastaanottaa viestin se emitoi sen 
  // kaikille clienteille heti
